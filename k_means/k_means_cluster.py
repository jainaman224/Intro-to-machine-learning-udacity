...
for each in data_dict:
    if data_dict[each][feature_1] < minimum and data_dict[each][feature_1] != 0:
        minimum = data_dict[each][feature_1]
    if data_dict[each][feature_1] > maximum and not math.isnan(float(data_dict[each][feature_1])):
        maximum = data_dict[each][feature_1]
